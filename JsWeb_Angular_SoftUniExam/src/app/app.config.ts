...
import { environment } from '../environments/environment'; // Import your environment for Firebase config
...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideFirebaseApp(() => initializeApp(environment.firebaseConfig)), // Initialize Firebase with the configuration
